...
export default function JourneySection() {
  ...
  const hideStyle =
    "flex flex-col gap-3 h-20 w-[635px] mt-1 rounded-sm border border-gray-100 py-2 px-5 cursor-pointer";
  const showStyle =
    "flex flex-col gap-3 mt-1 w-[635px] rounded-sm border border-gray-100 py-2 px-5 cursor-pointer bg-white shadow-lg";
  return (
    <section>
