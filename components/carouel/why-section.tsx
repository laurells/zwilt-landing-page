                    ...
                    <div className="flex mt-4 flex-col gap-4">
                      ...
                      <ul className="flex flex-col gap-4">
                        <li className="flex items-center  gap-2">
                          <div className="h-2 max-w-72 bg-[#FFBE2E] rounded-lg w-4" />
                          <p className="text-sm">
                        ...
                        <li className="flex items-center  gap-2">
                          <div className="h-2 max-w- bg-[#FFBE2E] rounded-lg w-4" />
                          <p className="text-sm">
                ...
                <div className="flex-none gap-2 flex-shrink-0 w-full min-w-0 ">
                  <div className=" shadow-xl rounded-md ml-2 bg-white p-14 font-semibold flex items-center h-[652px]">
                    <div className="flex mt-4 flex-col gap-4">
                      ...
                      <ul className="flex flex-col gap-4">
                        <li className="flex items-center  gap-2">
                          <div className="h-2 max-w-96 bg-[#FFBE2E] rounded-lg w-4" />
